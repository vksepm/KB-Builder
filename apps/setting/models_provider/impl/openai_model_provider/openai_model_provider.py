...
model_dict = {
    ...
    'gpt-4o-mini': ModelInfo('gpt-4o-mini', '最新的GPT-4o-mini，比gpt-3.5-turbo更便宜、更智能，随OpenAI调整而更新',
                             ModelTypeConst.LLM, openai_llm_model_credential,
                             ),
    ...
    'gpt-4o-mini-2024-07-18': ModelInfo('gpt-4o-mini-2024-07-18',
                                        '2024年7月18日的gpt-4o-mini快照',
                                        ModelTypeConst.LLM, openai_llm_model_credential,
                                        ),
