<template>
  <el-dialog title="选择问答库" v-model="dialogVisible" width="600" class="select-dataset-dialog">
    <template #header="{ titleId, titleClass }">
      <div class="my-header flex">
        <h4 :id="titleId" :class="titleClass">选择问答库</h4>
                ...
                >
                  <el-radio :value="item.id" size="large">
                    <div class="flex align-center">
                      <AppAvatar v-if="item?.type === '0'" class="mr-8 avatar-light" shape="square" :size="32">
