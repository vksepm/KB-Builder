<template>
  <el-dialog :title="title" v-model="dialogVisible" width="60%" class="paragraph-dialog" align-center destroy-on-close>
    <el-row v-loading="loading">
      <el-col :span="24">
        ...
        <div class="text-right p-24 pt-0" v-if="problemId && isEdit">
          <el-button @click.prevent="cancelEdit"> Cancel </el-button>
...
const submitHandle = async () => {
  if (await paragraphFormRef.value?.validate()) {
    ...
    if (problemId.value) {
      ...
      //     }
      //     : paragraphFormRef.value?.form
      const obj = paragraphFormRef.value?.form
