<template>
  <el-dialog title="选择问答库/文档" v-model="dialogVisible" width="500">
    <el-form
      ref="formRef"
      :model="form"
      label-position="top"
      ...
      @submit.prevent
    >
      <el-form-item label="选择问答库" prop="dataset_id">
        <el-select
...
const rules = reactive<FormRules>({
  dataset_id: [{ required: true, message: '请选择问答库', trigger: 'change' }],
